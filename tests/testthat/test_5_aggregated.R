...
testthat::test_that("dimensions", {
  ...
  #             sep = "|"),
  #       collapse = "', '")
  test_dim.ls <- list(LAT = c("metabolomics_liver_c18hyper_pos|6287|28",
                              "metabolomics_liver_hilic_neg|3145|28",
                              "metabolomics_plasma_c18acqui_neg|2088|28",
                              "metabolomics_plasma_c18acqui_pos|8542|28",
                              "metabolomics_plasma_c18hyper_pos|4789|28",
                              "metabolomics_plasma_hilic_neg|3133|28",
                              "preclinical|188|28",
                              "proteomics_liver|2098|28",
                              "proteomics_plasma|419|24"),
                      MX2 = c("metabolomics_liver_c18hyper_pos|6287|29",
                              "metabolomics_liver_hilic_neg|3145|29",
                              "metabolomics_plasma_c18acqui_neg|2088|29",
                              "metabolomics_plasma_c18acqui_pos|8542|29",
                              "metabolomics_plasma_c18hyper_pos|4789|29",
                              "metabolomics_plasma_hilic_neg|3133|29",
                              "preclinical|230|29",
...
testthat::test_that("significant", {
  ...
  #             sep = "|"),
  #       collapse = "', '")
  test_signif.ls <- list(LAT = c("metabolomics_liver_c18hyper_pos|1757",
                                 "metabolomics_liver_hilic_neg|865",
                                 "metabolomics_plasma_c18acqui_neg|0",
                                 "metabolomics_plasma_c18acqui_pos|1",
                                 "metabolomics_plasma_c18hyper_pos|3",
                                 "metabolomics_plasma_hilic_neg|585",
                                 "preclinical|0",
                                 "proteomics_liver|257",
                                 "proteomics_plasma|7"),
                         MX2 = c("metabolomics_liver_c18hyper_pos|21",
                                 "metabolomics_liver_hilic_neg|5",
                                 "metabolomics_plasma_c18acqui_neg|1",
                                 "metabolomics_plasma_c18acqui_pos|76",
                                 "metabolomics_plasma_c18hyper_pos|81",
