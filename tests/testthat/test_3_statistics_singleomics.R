...
testthat::test_that("dimensions", {
  ...
  #             sep = "|"),
  #       collapse = "', '")
  test_dim.vc <- c("metabolomics_liver_c18hyper_pos|4880|42",
                   "metabolomics_liver_hilic_neg|2583|42",
...
testthat::test_that("significant", {
  ...
  #             sep = "|"),
  #       collapse = "', '")
  test_signif.vc <- c("metabolomics_liver_c18hyper_pos|1649|NA|54",
                      "metabolomics_liver_hilic_neg|784|NA|24",
                      "metabolomics_plasma_c18acqui_neg|3|NA|1",
                      "metabolomics_plasma_c18acqui_pos|8|NA|115",
                      "metabolomics_plasma_c18hyper_pos|2|NA|97",
                      "metabolomics_plasma_hilic_neg|642|NA|58",
                      "preclinical|0|NA|1",
