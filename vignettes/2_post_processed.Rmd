...
stopifnot(identical(dim(preclinic_fda.df), as.integer(c(233, 2))))
```
...
<!-- ```{r proteo_imputation_metrics} -->
<!-- proteomics_imputed.ls <- list() -->

<!-- for (set.c in ProMetIS::proteo_sets.vc()) { -->

<!--   eset <- proteo.mset[[set.c]] -->

<!--   proteomics_imputed.ls[[set.c]] <- .format_imputation(eset) -->

<!-- } -->

<!-- save(proteomics_imputed.ls, -->
<!--      file = file.path(gsub(ProMetIS::data_dir.c(), -->
<!--                                  "../../ProMetIS/inst/extdata", -->
<!--                                  ProMetIS::post_processed_dir.c()), -->
<!--                       "proteomics_imputed.rdata")) -->
<!-- ``` -->
...
|step                |liver_c18hyper_pos |liver_hilic_neg    |plasma_c18hyper_pos|plasma_hilic_neg   |plasma_c18acqui_pos|plasma_c18acqui_neg|
|--------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|
|0.4 <= RT <= 22     |                   |                   |                   |                   |         X         |         X         |
|blank/samp   <= 0.33|         X         |         X         |         X         |         X         |         X         |         X         |
|poolDil: cor >= 0.7 |         X         |         X         |         X         |         X         |                   |                   |
|drift samp, span = 2|         X         |         X         |         X         |         X         |         X         |         X         |
