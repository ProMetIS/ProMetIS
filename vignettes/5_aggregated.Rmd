...
```{r}
latmx2.mset <- phenomis::reading(ProMetIS::statistics_integrative_dir.c(), report.c = "none")
```
...
for (gene.c in ProMetIS::genes.vc()) {
  ...
  # fig_prefix.c <- file.path(gsub(ProMetIS::data_dir.c(),
  #                                file.path(dirname(getwd()), "vignettes", "figures", "aggregated"),
  #                                ProMetIS::aggregated_dir.c(gene.c = gene.c))
