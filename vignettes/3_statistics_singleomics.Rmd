...
```{r}
load("../inst/extdata/3_statistics_singleomics/metadata_supp.rdata")
for (set.c in names(latmx2.mset)) {
  eset <- latmx2.mset[[set.c]]
  Biobase::fData(eset) <- cbind.data.frame(Biobase::fData(eset),
                                           metadata_supp.ls[[set.c]][["fdata"]],
...
latmx2.mset <- ProMetIS:::metadata_select(latmx2.mset, step.c = "3_statistics_singleomics")
